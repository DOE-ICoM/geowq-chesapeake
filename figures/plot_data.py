...
[ph.map_counts(df,column,startDate = startDate,endDate=endDate,num=100) for column in columns]


# map the mean clumn value over a given date range.
[ph.map_variable(df,column,startDate = startDate,endDate=endDate) for column in columns]
